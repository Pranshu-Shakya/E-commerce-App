...
const Navbar = () => {
	...
	return (
		<div className="fixed top-0 left-0 right-0 z-50">
			<div className="flex items-center justify-between py-3 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] font-medium backdrop-blur-sm bg-white/70 border-b border-white/20 shadow-lg">
				<Link to="/">
					<img src={assets.LogoBlack} className="w-40" alt="" />
				</Link>
