	...
	return (
		<div className="max-w-lg mx-auto bg-white pt-12">
			<p className="mb-6 text-gray-700 text-sm">
				Manage your privacy preferences. You can control how your data is used and how we
				communicate with you. For more details, please review our{" "}
			...
			<div className="space-y-6">
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-gray-500 text-xs">
							Get updates on offers, new products, and more.
						</p>
					</div>
					<button
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-gray-500 text-xs">
							Permit sharing of your data with trusted partners for better service.
						</p>
					</div>
					<button
				...
				<div className="flex items-center justify-between">
					...
					>
						<span
							className={`bg-white w-4 h-4 rounded-full shadow transform duration-300 ${
								settings.personalizedAds ? "translate-x-6" : ""
							}`}
						></span>
					</button>
				</div>
			...
			<div className="mt-8 text-xs text-gray-500 border-t pt-4">
				<p>
					Your privacy is important to us. You can update your preferences at any time.
